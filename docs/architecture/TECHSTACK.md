...
- **물리 기반 레이아웃**: Force-Directed 그래프로 캐릭터 관계를 자연스럽게 시각화 (Canvas 2D 가속 지원)
- **Obsidian 스타일**: 얇은 간선, 부드러운 애니메이션, 직관적인 노드 디자인 (1000+ 노드 대응)
...
| **idb-keyval** | 6.2  | IndexedDB 유틸     | 분석 버퍼 영구 저장 (Zustand)    |
