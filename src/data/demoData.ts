...
export const DEMO_ITEMS: Item[] = [
  {
    ...
    name: "은촛대",
    type: "accessory",
    currentOwnerId: "char-1", // 장발장
    extras: {
      설명: "미리엘 주교가 장발장에게 준 은촛대. 그의 구원과 새로운 삶의 상징.",
      가치: "매우 높음",
      상징성: "구원, 용서, 새로운 시작",
    },
    createdAt: "2024-01-01",
  ...
  },
  {
    ...
    currentOwnerId: "char-1", // 장발장
    extras: {
      설명: "장발장의 전과 기록을 나타내는 황색 여권. 사회에서 그를 배척하게 만든 문서.",
      가치: "없음",
      상징성: "사회적 낙인, 편견",
    },
    createdAt: "2024-01-01",
  ...
  },
  {
    ...
    currentOwnerId: "char-1", // 장발장
    extras: {
      설명: "팡틴이 죽기 전 코제트에게 남긴 편지. 장발장이 보관 중.",
      가치: "정서적 가치",
      상징성: "모성애, 희생",
    },
    createdAt: "2024-01-02",
  ...
  },
  {
    ...
    name: "자베르의 수갑",
    type: "weapon",
    currentOwnerId: "char-2", // 자베르
    extras: {
      설명: "자베르가 범죄자를 체포할 때 사용하는 수갑.",
      가치: "관직의 상징",
      상징성: "법과 질서, 억압",
    },
    createdAt: "2024-01-02",
  ...
  },
  {
    ...
    name: "코제트의 인형",
    type: "other",
    currentOwnerId: "char-4", // 코제트
    extras: {
      설명: "장발장이 코제트에게 처음 사준 인형. 그녀에게 희망을 준 선물.",
      가치: "정서적 가치",
      상징성: "순수함, 사랑",
    },
    createdAt: "2024-01-03",
  ...
  },
  {
    ...
    name: "마리우스의 편지",
    type: "document",
    currentOwnerId: "char-5", // 마리우스
    extras: {
      설명: "마리우스가 코제트에게 보낸 연애 편지.",
      가치: "정서적 가치",
      상징성: "사랑, 희망",
    },
    createdAt: "2024-01-04",
  ...
  },
  {
    ...
    name: "혁명 깃발",
    type: "other",
    currentOwnerId: "char-7", // 앙졸라
    extras: {
      설명: "ABC의 벗들이 사용하는 붉은 깃발. 혁명의 상징.",
      가치: "상징적 가치",
      상징성: "자유, 평등, 혁명",
    },
    createdAt: "2024-01-05",
