              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-4 mb-1.5">
                    <h5 className="text-base font-bold text-espresso-900 leading-tight group-hover:text-mocha-800 transition-colors font-serif break-keep">
                      {scene.title}
                    </h5>
                    {onNavigate && (
