...
export function CreateBookCard({ onClick, disabled }: CreateBookCardProps) {
  return (
    ...
    >
      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-muted text-muted-foreground shadow-sm transition-colors group-hover:bg-paper group-hover:text-mocha-500">
