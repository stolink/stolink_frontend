...
import { ForeshadowingSuggestList, type ForeshadowingSuggestListProps } from "./ForeshadowingSuggestList";
    ...
    addOptions() {
        return {
            ...
            suggestion: {
                ...
                render: () => {
                    let component: ReactRenderer<ForeshadowingSuggestListRef, ForeshadowingSuggestListProps>;
