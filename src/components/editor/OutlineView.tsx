...
export default function OutlineView({ folderId, projectId }: OutlineViewProps) {
  ...
  if (isLoading) return <div className="p-8 text-stone-400">Loading outline...</div>;
    ...
    <div className="flex-1 overflow-auto p-6 bg-white">
      <div className="max-w-5xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-stone-500 text-sm mt-1">섹션별 시놉시스와 진행 상태를 한눈에 파악합니다.</p>
        </header>
        ...
        <div className="border rounded-lg overflow-hidden border-stone-200 shadow-sm">
          <Table>
            ...
            <TableBody>
              ...
              {children.length === 0 && (
                 <TableRow>
                   <TableCell colSpan={5} className="text-center py-12 text-stone-400 italic">
                     이 폴더에 섹션이 없습니다.
                   </TableCell>
                 </TableRow>
              )}
