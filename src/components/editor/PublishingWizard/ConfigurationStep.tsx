  ...
  return (
    <div className="flex gap-4 h-[500px]">
      ...
      <div className="flex-1 flex flex-col">
        <h3 className="text-sm font-bold text-espresso-500 uppercase tracking-wide mb-3">
          배포 방식
        </h3>
          ...
          <label
            className={cn(
              ...
              deployMode === "individual"
                ...
                : "border-cloud-200 hover:border-mocha-300 bg-white",
            )}
          >
            <input
              type="radio"
              ...
              className="mt-1 w-4 h-4 text-mocha-500 border-cloud-300 focus:ring-mocha-400"
            />
            <div>
        ...
        {deployMode === "merge" && (
          <div className="mt-4">
            <Label
              ...
              className="text-xs font-bold text-espresso-500 uppercase tracking-wide mb-2 block"
            >
              병합 에피소드 제목
            </Label>
            <input
              ...
              className="w-full px-4 py-3 bg-cloud-50 border border-cloud-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-mocha-400/30 focus:border-mocha-400"
            />
          </div>
        )}
      </div>
      ...
      {/* 오른쪽: 선택된 섹션 (순서 변경 가능) */}
      <div className="w-80 flex flex-col bg-cloud-50 rounded-2xl p-4 border border-cloud-200">
        <h3 className="text-sm font-bold text-espresso-500 uppercase tracking-wide mb-3">
        ...
        {/* 안내 문구 */}
        <p className="text-xs text-espresso-400 text-center mt-3">
          드래그하여 순서 변경
        </p>
