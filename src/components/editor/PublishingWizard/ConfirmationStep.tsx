...
export function ConfirmationStep({
  ...
  return (
    <div className="max-w-lg mx-auto space-y-6">
      {/* 배포 요약 카드 */}
      <div className="bg-white rounded-2xl border border-stone-200 shadow-paper overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex justify-between">
            <span className="text-stone-500">배포 방식</span>
          ...
          {deployMode === "merge" && (
            <div className="flex justify-between">
              <span className="text-stone-500">에피소드 제목</span>
          ...
          {/* 포함 섹션 */}
          <div className="flex justify-between">
            <span className="text-stone-500">포함 섹션</span>
            <span className="font-semibold text-espresso-900 max-w-[200px] truncate">
        ...
        {/* 함께 배포되는 데이터 */}
        <div className="px-5 py-4 border-t border-stone-100 bg-cloud-50/50">
          <h4 className="text-sm font-bold text-stone-500 uppercase tracking-wide mb-3">
            함께 배포되는 데이터
          </h4>
