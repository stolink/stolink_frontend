    ...
    <div className="space-y-6 h-full flex flex-col">
      ...
      {isEditMode ? (
        <div className="flex-1 flex flex-col gap-6 min-h-0">
          ...
          <div className="shrink-0 p-4 rounded-2xl bg-stone-50/50 border border-stone-100 opacity-60 hover:opacity-100 transition-opacity">
            <p className="text-xs text-stone-400 font-medium mb-2 uppercase tracking-wider text-center">
              참고용 타임라인 (수정 불가)
            </p>
            <BiographyTree
          ...
          <div className="flex-1 relative group">
            <Textarea
              ...
              className="w-full h-full min-h-[300px] leading-relaxed font-serif text-lg p-8 bg-[#FDFCFB] shadow-sm border-stone-200 focus:border-stone-400 focus:ring-stone-200 resize-none selection:bg-stone-200 rounded-xl"
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-stone-200/50">
            <Button
              variant="outline"
              onClick={onCancel}
              className="h-11 px-6 rounded-full border-stone-300 text-stone-600 hover:bg-stone-100"
            >
            ...
            <Button
              onClick={onSave}
              className="h-11 px-8 rounded-full bg-stone-800 hover:bg-stone-900 text-white shadow-lg hover:shadow-xl transition-all"
            >
