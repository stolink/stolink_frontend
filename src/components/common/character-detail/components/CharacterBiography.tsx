        ...
        <div className="flex-1 flex flex-col gap-6 min-h-0">
          ...
          <div className="flex-1 relative group">
            <Textarea
              ...
              className="w-full h-full min-h-[300px] leading-relaxed font-serif text-lg p-8 bg-[#FDFCFB] shadow-sm border-cloud-200 focus:border-mocha-400 focus:ring-cloud-200 resize-none selection:bg-cloud-200 rounded-xl"
